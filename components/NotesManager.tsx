...
const LoadingSpinner = () => (
  <div className="flex flex-col items-center justify-center min-h-[300px] sm:min-h-[500px] animate-fade-in-up">
                        ...
                        <div className="flex flex-col h-full overflow-hidden animate-fade-in-up bg-slate-50/50">
                            ...
                            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar bg-slate-50/30 pb-20">
                                {isLoading || isFiltering ? (
                                    ...
                                    <div className="h-full flex flex-col items-center justify-center text-slate-400 opacity-60 min-h-[300px] sm:min-h-[500px] animate-fade-in-up">
